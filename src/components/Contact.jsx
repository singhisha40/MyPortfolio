    ...
    <section id="contact">
      ...
      <div className={`${styles.inner} fade-in`} ref={ref}>
        <div className={styles.left}>
          ...
          <p className={styles.sub}>I'm actively looking for development opportunities. If you're building something interesting or just want to talk code, reach out.</p>
        </div>
